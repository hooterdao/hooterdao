...
function OhmMenu() {
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="OWL Token" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography className="ohm-menu-button-text">OWL</Typography>
      </Button>
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      {OHM_ADDRESS && (
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={addTokenToWallet("OWL", OHM_ADDRESS, address)}
                        >
                          <SvgIcon
